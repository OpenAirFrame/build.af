import { Node, PostfixUnaryExpression, SyntaxKind } from "ts-morph";
import Context from "../context";
import { printNode } from "../printer";

export default function writePostfixUnaryExpression(_node: Node, context: Context): string {
  let node = _node as PostfixUnaryExpression;
